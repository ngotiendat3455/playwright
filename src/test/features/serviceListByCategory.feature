...
Scenario: View Subcategory in a Valid Category 
    When Locate the category menu or dropdown and Select a valid category as "Graphic Design"
    Then Display a list of available subcategories

Scenario: View Services in a Valid Category
    When Locate the category menu or dropdown and Hover a valid category as "Graphic Design" and Select a type service as "App Design"
    Then The system displays a list of services in the "Graphic Design" category
